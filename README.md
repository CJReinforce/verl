...
- [PURE](https://github.com/CJReinforce/PURE): **Credit assignment** method is the key to successful reinforcement finetuning using **process reward model** ![GitHub Repo stars](https://img.shields.io/github/stars/CJReinforce/PURE)
